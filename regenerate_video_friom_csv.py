...
# -*- coding: utf-8 -*-
# ==========================================================
# RE-GENERATE VIDEO FROM CSV
#   - 既存のCSVからデータを読み込み、動画のみ再作成する
#   - 座標オーバーフロー対策済み
# ==========================================================
...
# 新しく作る動画ファイル名
OUT_VIDEO = "./movie/hybrid_debug_fixed.mp4"
...
J_MAP = {n: i for i, n in enumerate(MP_JOINTS)}
...
def load_csv_data(csv_path):
    ...
    # {frame: {'people': {pid: kps3d}, 'ball': ball3d}}
    data = {} 
...
def main():
    ...
    print("Regenerating video from CSV data...")
                        ...
                        for tip in [17, 18, 19, 20, 21, 22]:
                            if tip in kps2d:
                                ...
                                if 0 <= pt[0] < W and 0 <= pt[1] < H:
                                    cv2.circle(frames[cam_i], pt, 4, (0,255,255), -1)
            ...
            if frame_info['ball'] is not None:
                ...
                for cam_i in range(3):
                    ...
                    if 0 <= bx < W and 0 <= by < H:
                        ...
                        cv2.putText(frames[cam_i], "BALL", (bx+10, by), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 165, 255), 1)
