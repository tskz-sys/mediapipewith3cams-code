...
# ★ ユーザー設定
# ==========================================
VIDEO_LEFT   = "../ffmpeg/movie/1208experiment/sync1/1match2_11.mp4"
VIDEO_CENTER = "../ffmpeg/movie/1208experiment/sync1/2match2_11.mp4"
VIDEO_RIGHT  = "../ffmpeg/movie/1208experiment/sync1/3match2_11.mp4"

CALIB_NPZ = "../calibrationwith3cams/output/1208_3cams_center_cam2.npz"

OUT_CSV   = "./output/old_test2/2_11.csv"
OUT_VIDEO = "./output/old_test2/2_11.mp4"
